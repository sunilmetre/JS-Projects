...
const genetareQrCodebtn = document.querySelector(".generate-qr-code-btn");
const errorMessageText = document.querySelector(".error-message-text");

genetareQrCodebtn.addEventListener("click", () => {
  validateInputField();
});
...
function generateQrCode() {
  ...
  (qrTextInput.value = ""), (errorMessageText.textContent = "");
}
